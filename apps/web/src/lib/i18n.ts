...
const messages = {
  "en-US": {
    ...
    "aiReviewStage3.external.error.invalid_schema": "The external response failed format or safety validation. Its supplemental opinion was rejected; the local deterministic assessment remains valid. Retry, or switch models if this persists.",
  ...
  "zh-CN": {
    ...
    "aiReviewStage3.external.error.invalid_schema": "外部模型返回内容未通过格式或安全边界校验，本次补充意见已拒绝；本地确定性评估仍有效。可重新运行，持续失败时切换模型。",
