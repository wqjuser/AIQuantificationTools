...
- 左侧导航和页面任务关系不够清晰。
- 策略编辑已经开始结构化，但还不是生产级策略工坊；后续还需要条件组合、用户自定义模板、参数对比和更清晰的版本治理。
- 数据源配置不是一等页面。
...
- 行情中心基础标的搜索和 K 线加载。
- 研究工作台图表和因子上下文。
- 策略工坊支持 SMA、RSI、成交量等基础可视化规则，并提供 SMA 趋势、RSI 反转和放量突破内置模板。
