...
export function useDomainRuntimeEffects(controller: Dependencies): Result {
  const {
    ...
    refreshStrategyProductionBinding, refreshVisiblePageData, refreshWorkspace, researchContextLinkCopyResetTimerRef, researchContextReadinessReportCopyResetTimerRef,
    ...
    setPendingSettingsWorkAreaId, setPendingStrategyGovernanceAction, setProductionStrategyHandoffState, setResearchNoteExternalDataApproved, setResearchNoteGenerationError,
