...
- 组合敞口和回撤。
- 跨策略资金分配。
- 组合回测；已完成从已审计 run 生成静态权重组合草稿、调用组合回测 API 和展示组合结果的 MVP，下一步推进再平衡、交易流水、敞口和风险贡献。
- 交易前风控引擎。
- 风控规则编辑器。
- 紧急停止和人工覆盖。
