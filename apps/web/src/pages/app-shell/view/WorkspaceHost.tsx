...
export function WorkspaceHost({ controller }: WorkspaceHostProps) {
  const {
    ...
    researchNoteGenerationStatus, researchNoteProviderId, researchNoteProviders, researchNoteState, researchP0Capabilities, runHistory,
    ...
    selectMarketInformationMarket, selectProductWorkArea, selectResearchNoteProvider, selectResearchP0Template, selectedResearchP0TemplateId, selectTimeframe, settingsConfigurationMessage,
              ...
              strategyWorkbench={(
                <>
                  ...
                  <StrategyResearchSection
                    ...
                    onSelectFormalP0Template={selectResearchP0Template}
                    providers={researchNoteProviders}
                    selectedFormalP0TemplateId={selectedResearchP0TemplateId}
