...
8. 研究工作台底部贴合专项：源图为 `/Users/wenqingjie/Library/Containers/com.sw33tlie.macshot.macshot/Data/Library/Application Support/com.sw33tlie.macshot/clipboard/Screenshot 2026-07-16 at 17-51-10.png`，实现截图为 `/private/tmp/aiquant-research-gap-final.png`；视口 `1680 × 962`，浅色主题，研究工作台、`600000`、日 K 状态。全图与底部状态栏区域对照确认原 10px 空隙已归零，主网格底边与状态栏上沿同为 900px，页面无横向溢出。字体、颜色、图表资产、文案和交互均未改动，四张摘要卡没有裁切；初始 P2 间距问题已修复，复验无 P0/P1/P2 遗留。
