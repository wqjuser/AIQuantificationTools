...
const messages = {
  "en-US": {
    ...
    "strategy.rsiWindow": "Period",
    "strategy.rsiThreshold": "Threshold",
    "strategy.volumeConfirm": "Volume confirmation",
    "strategy.volumeWindow": "MA period",
    ...
    "strategy.deleteVersion": "Delete",
    "strategy.deleteVersionLabel": "Delete strategy version {name}, revision {revision}",
    "strategy.deleteConfirmTitle": "Delete this saved version?",
    "strategy.deleteConfirmDetail": "This removes only the local strategy library entry. The current draft, research runs, experiments, and audit evidence remain available. This action cannot be undone.",
    "strategy.deleteCancel": "Cancel",
    "strategy.deleteConfirm": "Delete version",
    "strategy.deletingVersion": "Deleting",
    "strategy.deleteFailed": "The strategy version could not be deleted. Please try again.",
    "strategy.context": "Context",
    "strategy.auditRun": "Audit run",
    "strategy.diff": "Diff",
    "strategy.diffChanged": "{count} changes",
    "strategy.diffSame": "same as draft",
    "strategy.aiAssist": "AI assist",
    "strategy.aiTitle": "Create a strategy draft with AI",
    "strategy.aiSubtitle": "Describe the objective, review the structured candidate and rationale, then apply it explicitly.",
    "strategy.aiGoal": "Strategy objective",
    "strategy.aiGoalPlaceholder": "For example: Build a medium-low risk daily trend strategy with confirmation filters and controlled drawdown.",
    "strategy.aiProvider": "AI provider",
    "strategy.aiExternalSummary": "Only the market, symbol, timeframe, objective, and current structured draft are sent. No raw bars, account data, orders, or keys are included.",
    "strategy.aiExternalApproval": "Allow sending the summary above for this generation",
    "strategy.aiGenerate": "Generate candidate",
    "strategy.aiGenerating": "Generating candidate",
    "strategy.aiPreview": "Candidate preview",
    "strategy.aiReasons": "Why it is written this way",
    "strategy.aiApply": "Apply to current draft",
    "strategy.aiClose": "Close",
    "strategy.aiDraftOnly": "Draft only · not saved · not run · paper only",
    "strategy.aiFallback": "The external model did not produce a trusted candidate. The current draft was preserved.",
    "strategy.aiGenerateFailed": "Strategy generation failed. The current draft was not changed.",
    "strategy.aiTimedOut": "AI generation timed out after 45 seconds. The current draft was not changed.",
    "strategy.aiContextChanged": "The instrument, timeframe, or draft changed. Generate a new candidate for the current context.",
    "strategy.aiCancelGeneration": "Cancel generation",
    "strategy.aiLocalBaseline": "Local baseline · reference only",
    "strategy.aiFallbackBadge": "Safe fallback · reference only",
    "strategy.aiEnabled": "Enabled",
    "strategy.aiRetainedParameter": "retained parameter:",
    "strategy.aiExecutionMode": "Execution mode",
    "strategy.aiPaperOnly": "Paper only",
    "strategy.aiNonPaperBlocked": "Non-paper mode · blocked",
    "strategy.aiChanges": "Changes to review",
    "strategy.aiCurrentValue": "Current draft",
    "strategy.aiCandidateValue": "AI candidate",
    "strategy.aiNoChanges": "The candidate matches the current draft. There is nothing to apply.",
    "strategy.aiDisabled": "Disabled",
    ...
    "strategyExperiment.holdoutConsumed": "This research snapshot's test holdout was consumed by an older experiment. Run research again to create a fresh audited snapshot, then rerun AI review.",
    ...
    "aiReviewStage3.outbound.completedKlines": "Frozen completed original K-lines",
    ...
    "aiReviewStage3.external.error.timeout": "The external model timed out. Retry the review in a moment.",
    "aiReviewStage3.external.error.invalid_schema": "The external response failed format validation. Its supplemental opinion was rejected; the local deterministic assessment remains valid. Retry, or switch models if this persists.",
    "aiReviewStage3.external.error.execution_semantics": "The external model returned execution semantics such as buying, holding, target prices, or orders. Its supplemental opinion was rejected; the local deterministic assessment remains valid. Retry, or switch models if this persists.",
    ...
    "aiReviewStage3.consistency.insufficient": "Not enough comparisons",
    ...
    "aiReviewStage3.error.serviceLoadFailed": "AI review service could not be loaded.",
    "aiReviewStage3.error.historyLoadFailed": "AI review history could not be loaded.",
  ...
  "zh-CN": {
    ...
    "execution.stage5.eyebrow": "阶段 5 · 影子执行",
    "execution.stage5.title": "影子执行操作台",
    "execution.stage5.subtitle": "将阶段 4 权威工作流投影到隔离的本地适配器，并从持久化证据恢复。",
    "execution.stage5.boundary": "仅限影子执行 · 不连接券商、不访问账户、不路由订单",
    "execution.stage5.start": "启动影子验证",
    "execution.stage5.retry": "重试超时影子验证",
    "execution.stage5.readinessAction": "生成测试网准入决策",
    "execution.stage5.authorizationPreflightAction": "生成测试网授权预检",
    "execution.stage5.authorizationReviewAction": "记录测试网授权复核",
    ...
    "execution.stage5.busy": "影子验证正在运行。",
    "execution.stage5.workflowMissing": "请先入账阶段 4 权威工作流。",
    "execution.stage5.sessionBlocked": "影子会话已阻断，请复核持久化证据。",
    ...
    "execution.stage5.killSwitch": "急停开关启用 / 触发",
    "execution.stage5.reconciliation": "对账",
    "execution.stage5.sessionHash": "会话哈希",
    "execution.stage5.orders": "影子委托证据",
    "execution.stage5.safety": "仅模拟、仅影子执行；实盘与订单路由已阻断",
    "execution.stage5.readinessTitle": "测试网准入决策",
    "execution.stage5.readinessBoundary": "仍禁止测试网下单 · 必须经过后续独立人工授权",
    "execution.stage5.authorizationPreflightTitle": "测试网授权预检",
    "execution.stage5.authorizationPreflightBoundary": "材料仅可提交独立人工授权 · 测试网与实盘订单仍被禁止",
    "execution.stage5.authorizationReviewTitle": "测试网授权复核",
    "execution.stage5.authorizationReviewBoundary": "复核已入账 · 授权未生效 · 测试网与实盘订单仍被禁止",
    "execution.stage5.exitTitle": "阶段 5 顶层退出验收",
    "execution.stage5.exitUnavailable": "退出证据尚不可用",
    "execution.stage5.exitBoundary": "阶段 5 已进入维护 · 测试网与实盘订单路由继续阻断",
    ...
    "strategy.deleteVersion": "删除",
    "strategy.deleteVersionLabel": "删除策略版本 {name}，修订版 {revision}",
    "strategy.deleteConfirmTitle": "确认删除这个保存版本？",
    "strategy.deleteConfirmDetail": "这里只会移除本地策略库条目，当前草稿、研究运行、策略实验和审计证据都会继续保留。删除后无法撤销。",
    "strategy.deleteCancel": "取消",
    "strategy.deleteConfirm": "确认删除",
    "strategy.deletingVersion": "删除中",
    "strategy.deleteFailed": "策略版本删除失败，请重试。",
    "strategy.context": "上下文",
    "strategy.auditRun": "审计运行",
    "strategy.diff": "差异",
    "strategy.diffChanged": "{count} 项差异",
    "strategy.diffSame": "与草稿一致",
    "strategy.aiAssist": "AI 帮写",
    "strategy.aiTitle": "用 AI 编写策略草稿",
    "strategy.aiSubtitle": "描述你的目标，先查看结构化候选和编写原因，确认后再应用到当前草稿。",
    "strategy.aiGoal": "策略目标",
    "strategy.aiGoalPlaceholder": "例如：编写一套中低风险的日线趋势策略，增加确认条件并控制回撤。",
    "strategy.aiProvider": "AI 提供方",
    "strategy.aiExternalSummary": "仅发送市场、标的、周期、策略目标和当前结构化草稿；不会发送原始 K 线、账户、订单或密钥。",
    "strategy.aiExternalApproval": "本次允许发送上述摘要",
    "strategy.aiGenerate": "生成候选",
    "strategy.aiGenerating": "正在生成候选",
    "strategy.aiPreview": "候选预览",
    "strategy.aiReasons": "为什么这样编写",
    "strategy.aiApply": "应用到当前草稿",
    "strategy.aiClose": "关闭",
    "strategy.aiDraftOnly": "仅生成草稿 · 未保存 · 未运行 · 仅模拟盘",
    "strategy.aiFallback": "外部模型未生成可信候选，当前草稿已原样保留。",
    "strategy.aiGenerateFailed": "策略生成失败，当前草稿没有变化。",
    "strategy.aiTimedOut": "AI 生成超过 45 秒，已自动取消；当前草稿没有变化。",
    "strategy.aiContextChanged": "标的、周期或当前草稿已经变化，请基于当前上下文重新生成候选。",
    "strategy.aiCancelGeneration": "取消生成",
    "strategy.aiLocalBaseline": "本地基线 · 仅供对照",
    "strategy.aiFallbackBadge": "安全回退 · 仅供对照",
    "strategy.aiEnabled": "已启用",
    "strategy.aiRetainedParameter": "保留参数：",
    "strategy.aiExecutionMode": "执行模式",
    "strategy.aiPaperOnly": "仅模拟盘",
    "strategy.aiNonPaperBlocked": "非模拟盘 · 已阻断",
    "strategy.aiChanges": "需要确认的变更",
    "strategy.aiCurrentValue": "当前草稿",
    "strategy.aiCandidateValue": "AI 候选",
    "strategy.aiNoChanges": "候选与当前草稿一致，无需应用。",
    "strategy.aiDisabled": "未启用",
    ...
    "strategyExperiment.holdoutConsumed": "当前研究快照的测试留出集已被旧实验使用。请先在研究工作台重新运行研究生成新审计快照，再运行 AI 评审。",
    ...
    "aiReviewStage3.provider": "评审服务",
    "aiReviewStage3.configured": "已配置",
    "aiReviewStage3.notConfigured": "未配置",
    "aiReviewStage3.model": "模型",
    "aiReviewStage3.baseUrl": "已脱敏服务地址",
    "aiReviewStage3.outboundFields": "发送给外部模型服务的字段",
    ...
    "aiReviewStage3.outbound.completedKlines": "服务端冻结且已完成的原始 K 线",
    ...
    "aiReviewStage3.external.error.ai_review_provider_not_configured": "外部模型服务尚未配置。",
    "aiReviewStage3.external.error.timeout": "外部模型响应超时，请稍后重新运行评审。",
    "aiReviewStage3.external.error.invalid_schema": "外部模型返回内容未通过格式校验，本次补充意见已拒绝；本地确定性评估仍有效。可重新运行，持续失败时切换模型。",
    "aiReviewStage3.external.error.execution_semantics": "外部模型返回了买卖、持仓、目标价或订单等执行语义，本次补充意见已拒绝；本地确定性评估仍有效。可重新运行，持续失败时切换模型。",
    ...
    "aiReviewStage3.decision": "决策追加链",
    "aiReviewStage3.predecessor": "最新前序记录",
    "aiReviewStage3.noPredecessor": "无 · 第一条决策",
    "aiReviewStage3.operator": "操作人",
    "aiReviewStage3.decisionStatus": "决策状态",
    ...
    "aiReviewStage3.appendDecision": "追加决策",
    "aiReviewStage3.appending": "追加中",
    "aiReviewStage3.noCurrentReview": "运行或查看一条权威评审后，可查看独立评估与决策追加链。",
    ...
    "aiReviewStage3.consistency.insufficient": "无足够对照",
    ...
    "aiReviewStage3.error.serviceLoadFailed": "AI 评审服务加载失败。",
    "aiReviewStage3.error.historyLoadFailed": "AI 评审历史加载失败。",
    ...
    "aiReviewStage3.error.decisionAppendFailed": "AI 评审决策追加失败。",
    "aiReviewStage3.error.decisionReadbackFailed": "AI 评审决策回读失败。",
    "archive.aiReview.authoritative": "权威评审",
    "archive.aiReview.decision": "决策",
    "archive.aiReview.group.authoritative": "包内权威评审",
    "archive.aiReview.group.decision": "包内决策",
    "archive.aiReview.sameHash": "哈希一致",
...
const labelMaps: Record<Locale, LocalizedLabelMap> = {
  "en-US": {
    ...
    statuses: {
      ...
      "Strategy version deleted": "Strategy version deleted",
      "Strategy version delete failed": "Strategy version delete failed",
      "Strategy governance action failed": "Strategy governance action failed",
      ...
      "AI strategy draft applied": "AI strategy draft applied",
  ...
  "zh-CN": {
    ...
    statuses: {
      ...
      "Strategy version deleted": "策略版本已删除",
      "Strategy version delete failed": "策略版本删除失败",
      "Strategy governance action failed": "策略治理操作失败",
      ...
      "AI strategy draft applied": "AI 策略草稿已应用，等待重新审计",
...
function translateDecisionMessage(locale: Locale, message: string): string {
  ...
  const incompleteEvidence = message.match(
    /^Evidence is incomplete; (\d+) required item\(s\) are missing or invalid\.$/
  );
  if (incompleteEvidence) {
    return `证据不完整：${incompleteEvidence[1]} 项必需证据缺失或无效。`;
  }
  if (message === "Evidence is complete and no deterministic caution threshold was crossed.") {
    return "证据完整，未触发确定性风险阈值。";
  }
  const cautionSignals = message.match(
    /^Evidence is complete with (\d+) deterministic caution signal\(s\)\.$/
  );
  if (cautionSignals) {
    return `证据完整，发现 ${cautionSignals[1]} 项确定性风险信号。`;
  }
