    ...
    *,
    ...
    risk_adjusted_target = build_risk_adjusted_target(
        ...
        evidence={
            ...
            "dailyLossDrawdownPct": round(daily_drawdown_pct, 4),
            "dailyLossLimitPct": daily_loss_limit_pct,
            "dailyProfitDrawdownPct": round(profit_drawdown_pct, 4),
            "dailyProfitDrawdownLimitPct": profit_drawdown_limit_pct,
